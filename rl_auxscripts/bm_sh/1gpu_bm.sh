...
MAINSCRIP="rl_scripts/bm_pipeline.py"
...
CUDA_VISIBLE_DEVICES=0 accelerate launch --config_file "${BASEJSON}1gpu.json" $MAINSCRIP --config ${BASECONF}1gpu_bm.py $DEBUG_FLAG
