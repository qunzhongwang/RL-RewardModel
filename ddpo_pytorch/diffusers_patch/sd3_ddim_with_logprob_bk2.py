...
def ddim_step_with_logprob(
    ...
    denominator = (sigma - sigma_next)**2+sigma_next**2*(1-sigma)**2
    prev_sample_mean = (1-sigma_next)*((sigma - sigma_next)**2*sample_0+sigma_next**2*(1-sigma)*sample)/denominator
    std_dev_t = sigma_next*(sigma - sigma_next)/torch.sqrt(denominator)
