...
from .sd3_ddim_with_logprob import ddim_step_with_logprob
...
def pipeline_with_logprob(
    ...
    with self.progress_bar(total=num_inference_steps) as progress_bar:
        for i, t in enumerate(timesteps):
            ...
            # 可能有bug,self.transformer的输入都是fp16，但输出是fp32,可能有部分模型参数是fp32
            ...
            # 修改步骤：使用带logprob的步骤函数
            latents, log_prob, log_prob1, log_prob2, log_prob3 = ddim_step_with_logprob(
                self.scheduler, 
                noise_pred, 
                t.unsqueeze(0), 
                latents,
            ...
            all_log_probs3.append(log_prob3)
    ...
    if not return_dict:
        return (image, all_latents, all_log_probs, all_log_probs1, all_log_probs2, all_log_probs3)

    return StableDiffusion3PipelineOutput(images=image), all_latents, all_log_probs