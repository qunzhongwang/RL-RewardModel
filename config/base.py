...
def get_config():
    ...
    config.output_dir = "log_pic"
    config.reward_pw_fn = "evaluate_promptImagePair_Openrouter"
    config.WithTie = False
    config.Project_name = "CKLST"
    config.pmtcnt = "3"

    
    config.reward_method = "unif"
    config.dataset_name = "/m2v_intern/liujie/research/huggingface/dataset/yuvalkirstain/pickapic_v1_unique"
    # config.dataset_name = "/m2v_intern/liujie/research/huggingface/dataset/imagereward/fidelity_rating_dataset"
    # config.dataset_name = "/m2v_intern/liujie/research/huggingface/dataset/yuvalkirstain/pickapic_v1"
    ###### General ######
    # run name for wandb logging and checkpoint saving -- if not provided, will be auto-generated based on the datetime.
    config.run_name = "CKLST"
