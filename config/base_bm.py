...
def get_config():
    ...
    config.inference_basedir = "log_inf"
    config.log_cot = True
    config.save_freq = 20
    ...
    config.resume_ckpt_id = "0"
    config.resume_ckpt = ""
    config.resume_gpus = 1
    config.resume_zeRO = 0
    ...
    config.Project_name = "Qwen_RL_benchmark"
